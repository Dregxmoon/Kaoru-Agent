...
| `helpers.js`                    | Funciones puras: descripción de triggers, filtro de relleno, extracción de parches `_extractPatch`, detección de media `_detectMediaTitle`/`_matchMediaTaste`, memoria, y **extracción del mensaje final de Qwen3** (descarta borradores `Draft:`/`Revised Draft:` y prosa libre) |
...
| `mixins/message-gen.js`         | Generación del mensaje con el LLM (identidad + memoria, anti-repetición, curiosidad, contexto de código, `disableThinking` para Qwen3/DeepSeek)                                                                                                                                   |
