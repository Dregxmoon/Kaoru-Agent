...
assert(a && a.params && a.params.path === 'hola.txt', 'write: params.path = hola.txt', JSON.stringify(a && a.params));
assert(a && a.params && typeof a.params.instruction === 'string' && a.params.instruction.length > 0,
  'write: params.instruction presente (para el flujo create_file)', JSON.stringify(a && a.params));
...
assert(a && a.params && a.params.command === 'npm test', 'exec: params.command = "npm test" (sin wrapper raw)', JSON.stringify(a && a.params));
